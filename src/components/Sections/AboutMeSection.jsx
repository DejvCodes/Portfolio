    ...
    <div className="about-me-container container">
      <div className="about-me-data">
        ...
        <p className="about-me-description">I'm 22 years old and I'm from Pardubice region in the Czech Republic.
          I'm a Front-End Developer at the beginning of my career and I really enjoy improving my coding
          skills, developing applications and websites.
        </p>
        <p className="about-me-second-description">Fan of cars, motorbikes, travelling, a
          good cup of coffee and of course coding.
        </p>
